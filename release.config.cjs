...
module.exports = {
  ...
  repositoryUrl: 'https://github.com/ionic-team/cordova-outsystems-health-fitness.git',
  plugins: [
    [
    ...
    // updates package.json version without npm publishing — this plugin is
    // installed via git URL (cordova plugin add <repo url>), not from npm
    [
